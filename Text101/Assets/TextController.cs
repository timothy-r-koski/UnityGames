...
public class TextController : MonoBehaviour {
	...
	public Text text;
	public enum States {cell, mirror, sheets_0, lock_0, cell_mirror, sheets_1, lock_1, freedom}; 
	...
	void state_mirror() {
		...
		if (Input.GetKeyDown(KeyCode.T)) 		{currentState = States.cell_mirror;}
		else if (Input.GetKeyDown(KeyCode.R)) 	{currentState = States.cell;}
    }
	...
	void state_cell_mirror() {
		...
		else if (Input.GetKeyDown(KeyCode.L)) 	{currentState = States.lock_1;}
    }
	...
	void state_lock_1() {
		...
		if (Input.GetKeyDown(KeyCode.O)) 		{currentState = States.freedom;}
		else if (Input.GetKeyDown(KeyCode.R)) 	{currentState = States.cell_mirror;}
    }
